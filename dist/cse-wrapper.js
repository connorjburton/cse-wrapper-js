...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSE = function () {
		function CSE(options) {
			_classCallCheck(this, CSE);
			...
			var mergedOpts = _.merge(defaults, options);
...
/***/ function(module, exports) {
	...
	var Validator = function () {
		...
		_createClass(Validator, [{
			key: 'requiredValues',
			value: function requiredValues(opts, type) {
				var passed = true;

				_.each(_.keys(_.pickBy(opts, _.isNull)), _.bind(function (o) {
					if (_.indexOf(this.required[type], o) !== -1) {
						passed = false;console.warn('[CSE Wrapper JS] ' + o + ' is missing');
					}
				}, this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Storage = function () {
		...
		_createClass(Storage, [{
			key: '_getHash',
			value: function _getHash(opts) {
				return JSON.stringify(opts).hashCode();
			}
		}, {
			key: 'has',
			value: function has(opts) {
